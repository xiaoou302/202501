                ...
                children: [
                  ...
                  Row(
                    children: [
                      CircleAvatar(
                        ...
                        child: Text(
                          pose.author.displayName[0].toUpperCase(),
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 10,
                  ...
                  if (pose.tags.isNotEmpty) ...[
                    ...
                    Wrap(
                      spacing: 4,
                      runSpacing: 4,
                      children: pose.tags.take(2).map((tag) {
                        return Container(
                          padding: const EdgeInsets.symmetric(
                            horizontal: 6,
                            vertical: 2,
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                subtitle: Text(
                  'Remove content and block ${pose.author.displayName}',
                  style: TextStyle(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  if (onReport != null) {
                    onReport!(pose.author.displayName);
                  }
                },
              ),
              const SizedBox(height: 20),
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              Navigator.pop(context);
              if (onDelete != null) {
                onDelete!(pose.author.displayName);
              }
            },
            style: TextButton.styleFrom(
              backgroundColor: AppConstants.theatreRed,
